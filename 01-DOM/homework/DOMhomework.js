...
// Tu código acá:
const creditos=document.querySelector("#createdBy");
creditos.innerHTML = "Aplicación creada por: Mary Laura Betancourt";
...
function addToDo() {
  // Tu código acá:
  //const inputValue= document.getElementsByName('toDoinput').value; MALO
   //const myToDo = new ToDo(inputValue);
  const input= document.getElementById('toDoInput')
  const myToDo = new ToDo(input.value);
